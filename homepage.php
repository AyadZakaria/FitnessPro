    ...
    <div class="home">
        ...
        <div class="body">
            ...
            <div class="left">
                ...
                <h1 class="text">Fitness Pro <br> We made it for your </br> Benefits.</h1>
                <p class="desc">Lorem ipsum dolor sit, amet consectetur adipisicing elit. <br> Vero explicabo blanditiis
                    quidem .</p>
                <p class="btn"><a href="signup.php"> Get started </a> </p>
            </div>
            <!--Social-->
            <div class="socio">
                <i class="fab fa-facebook"></i>
        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <hr>
                <!--Btn-->
                <button class="btn"><a href="signup.html">Get Started Free</a></button>
            </div>
            <!--Cd1-->
            <div class="card">
                <!--Top-->
                ...
                <hr>
                <!--Btn-->
                <button class="btn"><a href="signup.html">Choose Plan</a></button>
            </div>
            <!--Cd1-->
            <div class="card">
                <!--Top-->
        ...
        <div class="produit" id="oned">
            ...
            <div class="left">
                ...
                <div class="info">
                    ...
                    <h3>Whey Protein</h3>
                    <hr>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Delectus voluptas ducimus reiciendis
                        ratione non assumenda eligendi, voluptatum, facilis dicta sequi aspernatur voluptatibus quam in
                        laudantium sed nesciunt cumque earum iste maxime ex corrupti iure. Possimus autem asperiores in
                        et nam?</p>
        ...
        <div class="footer">
            ...
            <hr class="du">
            <p class="copy">Copyright &copy; 2022 Ayad Elhoure Ibril</p>
        </div>
